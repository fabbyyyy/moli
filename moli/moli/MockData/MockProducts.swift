...
struct MockProducts {
    ...
    static let takis      = Product(id: UUID(), name: "Takis Morados",    category: "Botanas",  sku: "TAK01", shelfLifeDays: 60, brand: "Barcel",   imageName: "takis",      unitPriceMXN: 19)
    static let polvorones = Product(id: UUID(), name: "Polvorones",       category: "Galletas", sku: "POL01", shelfLifeDays: 90, brand: "Marinela", imageName: "polvorones", unitPriceMXN: 22)

    static let allProducts = [panBlanco, gansito, donas, frituras, papas, takis, polvorones]
}
